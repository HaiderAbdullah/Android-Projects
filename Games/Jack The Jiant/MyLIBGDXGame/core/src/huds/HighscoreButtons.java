...
public class HighscoreButtons {
    ...
    private Label coinLabel, scoreLabel;
    ...
    void createAndPositionUIElements() {
        ...
        scoreLabel.setPosition(GameInfo.HEIGHT / 2f - 200, GameInfo.HEIGHT/ 2 - 120);
        coinLabel.setPosition(GameInfo.HEIGHT / 2f - 200, GameInfo.HEIGHT/ 2 - 215);
